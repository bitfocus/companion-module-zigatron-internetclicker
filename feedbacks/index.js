	...
	self.setFeedbackDefinitions({
		...
		connection_state: {
			...
			callback: (feedback, context) => {
				...
				state[ConnectionState.Connecting] = { color: options.state_connecting_color, bgcolor: options.state_connecting_bg }
				state[ConnectionState.Connected] =  { color: options.state_connected_color, bgcolor: options.state_connected_bg }
				state[ConnectionState.Disconnected] = { color: options.state_disconnected_color, bgcolor: options.state_disconnected_bg }
